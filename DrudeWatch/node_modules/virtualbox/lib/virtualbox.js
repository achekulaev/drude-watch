...
} else if (/^darwin/.test(host_platform)) {

  try {
    var macVboxManagePath = '/Applications/VirtualBox.app/Contents/MacOS/VBoxManage';
    fs.accessSync(macVboxManagePath, fs.X_OK);
    vBoxManageBinary = macVboxManagePath + ' ';
  } catch (e) {
    vBoxManageBinary = 'vboxmanage ';
  }

} else if (/^linux/.test(host_platform)) {
